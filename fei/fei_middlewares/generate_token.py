    ...
    def middleware(request):
        if request.user.is_authenticated:
            try:
                ...
                print(f'-- generate_token_if_not_exist --'.ljust(30), f'===> token already existed: {request.user}')
            ...
            # except Token.DoesNotExist as e:
                ...
                print(f'-- generate_token_if_not_exist --'.ljust(30), f'---> created token for user: {request.user}')
